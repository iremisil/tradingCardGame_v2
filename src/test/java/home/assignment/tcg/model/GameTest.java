...
public class GameTest {
    ...
    public void playerChangeAfterTurn() {
        ...
        game.damageOpponent(1, player1, player2);
    ...
    @Test
    public void damageSuccessForPlayer() {
        ...
        int beforeDamage = player1.getHealth();

        game.damageOpponent(1, player2, player1);

        int afterDamage = player1.getHealth();

        assertThat("Player health should be decrease ", afterDamage, is(beforeDamage - 1));
